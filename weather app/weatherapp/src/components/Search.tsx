  ...
  return (
    <main className="flex justify-center items-center bg-gradient-to-br from-sky-400 via-rose-400 to-lime-400 h-[100vh] w-full">
      <section className="bg-white bg-opacity-20 backdrop-blur-lg drop-shadow-lg rounded">
        ...
        <p className="text-sm mt-2">Enter a place</p>
        <div className="relative mt-10 md:mt-4">
          ...
          <button
            className="rounded-r-md border-2 border-zinc-100 hover:border-zinc-500 hover:text-zinc-500 text-zinc-500 px-2 py-1 cursor-pointer"
            onClick={onSubmit}
          >
            Search
          </button>
